...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("E:\\dev.js\\react-challenge-sort-and-search\\node_modules\\react-hot-api\\modules\\index.js"), RootInstanceProvider = require("E:\\dev.js\\react-challenge-sort-and-search\\node_modules\\react-hot-loader\\RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _UserList = __webpack_require__(161);

	var _UserList2 = _interopRequireDefault(_UserList);

	var _ActiveUser = __webpack_require__(163);
	...
	var App = function (_Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function sortBy(column) {
	            ...
	            this.state.dataListUsersView = this.state.dataListUsersView.sort(function (a, b) {
	                if (column == 'name') return (_this2.state.order ? 1 : -1) * (a.name < b.name ? -1 : a.name > b.name ? 1 : 0);else if (column == 'age') return (_this2.state.order ? 1 : -1) * (a.age - b.age);
	            });
	            this.setActiveUser();
	        }
	    }, {
	        key: 'searchFn',
	        value: function searchFn(value) {
	            this.state.dataListUsersView = this.state.dataListUsers.filter(function (item) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_SearchBar2.default, { searchValue: this.state.searchValue, searchByName: this.searchFn.bind(this) }),
	                _react2.default.createElement(_ToolBar2.default, { sortBy: this.sortBy.bind(this) }),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_ActiveUser2.default, { currentUser: this.state.currentUser })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'col-sm-8 col-md-9 col-lg-10' },
	                        _react2.default.createElement(_UserList2.default, { jsonData: this.state.dataListUsersView, setActiveUser: this.setActiveUser.bind(this), searchValue: this.state.searchValue })
	                    )
	                )
	            );
	        }
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("E:\\dev.js\\react-challenge-sort-and-search\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "App.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            "button",
	                            { className: "btn btn-default", onClick: this.sortBy.bind(this, 'name') },
	                            _react2.default.createElement("i", { className: "icon fa fa-sort-alpha-asc" }),
	                            _react2.default.createElement(
	                                "span",
	                                null,
	                        ...
	                        _react2.default.createElement(
	                            "button",
	                            { className: "btn btn-default", onClick: this.sortBy.bind(this, 'age') },
	                            _react2.default.createElement("i", { className: "icon fa fa-sort-numeric-asc" }),
	                            _react2.default.createElement(
	                                "span",
	                                null,
	                                " Сортировка по цене"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserData = __webpack_require__(162);
	...
	var UserList = function (_Component) {
		...
		_createClass(UserList, [{
			key: 'setCurrentUser',
			value: function setCurrentUser(id) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						rows.map(function (item) {
							return _react2.default.createElement(_UserData2.default, { searchValue: _this2.props.searchValue, key: item.id, user: item, setCurrentUser: _this2.setCurrentUser.bind(_this2) });
						})
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserData = function (_Component) {
					...
					function UserData() {
									...
									return _possibleConstructorReturn(this, Object.getPrototypeOf(UserData).apply(this, arguments));
					}
					...
					_createClass(UserData, [{
									...
									key: 'decoreName',
									value: function decoreName() {
													var name = this.props.user.name;
													if (this.props.searchValue.length > 0) {
																	var pattern = '(' + this.props.searchValue.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&") + ')';
									...
									value: function render() {
													...
													return _react2.default.createElement(
																	...
																	_react2.default.createElement(
																					'td',
																					null,
																					_react2.default.createElement('img', { src: 'images/' + this.props.user.image + '.jpg', className: 'user-image' })
																	),
																	_react2.default.createElement('td', { dangerouslySetInnerHTML: { __html: this.decoreName() } }),
																	_react2.default.createElement(
																					'td',
																					null,
																					this.props.user.age
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActiveUser = function (_Component) {
		...
		function ActiveUser() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(ActiveUser).apply(this, arguments));
		}
		...
		_createClass(ActiveUser, [{
			...
			value: function render() {
				...
				if (!currentUser.name) return _react2.default.createElement(
					"h3",
					null,
					"Nothing found :("
					...
					"div",
					{ className: "thumbnail" },
					_react2.default.createElement("img", { src: "images/" + currentUser.image + ".jpg" }),
					_react2.default.createElement(
						"div",
						{ className: "thumbnail-caption" },
						_react2.default.createElement("h3", { dangerouslySetInnerHTML: { __html: currentUser.name } }),
						_react2.default.createElement(
							"table",
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("E:\\dev.js\\react-challenge-sort-and-search\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ActiveUser.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Button = function Button(_ref) {
	  ...
	  return _react2.default.createElement(
	    "button",
	    { className: "btn btn-default", onClick: update },
	    "Кнопка была нажата ",
	    count,
	    " раз"
	  );
